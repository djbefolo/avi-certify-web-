...
export default function DocumentsPage() {
  ...
  return (
    <DashboardLayout
      title="Documents"
      description="Envoyez les pieces necessaires a l'analyse de votre dossier. Les fichiers restent rattaches a votre compte Firebase."
    >
        ...
        <div className="grid gap-5">
          ...
          <section className="rounded-md border bg-background p-5 shadow-sm md:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold">Conseils avant upload</h2>
                <ul className="mt-3 grid gap-2 text-sm leading-6 text-muted-foreground">
                  <li>Utilisez un PDF, JPG ou PNG lisible.</li>
                  <li>La taille maximale autorisee est de 5 MB.</li>
                  <li>Evitez les photos floues ou coupees.</li>
                  <li>Un document envoye passe au statut initial uploaded.</li>
                </ul>
              </div>
            </div>
          </section>
        ...
        <div className="grid gap-5">
          ...
          <section className="rounded-md border bg-background p-5 shadow-sm md:p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-xl font-semibold">Validation equipe</h2>
                <p className="mt-3 leading-7 text-muted-foreground">
                  Les statuts under_review, validated et rejected seront geres
                  par l'equipe AVI CERTIFY dans le futur espace admin. Le client
                  ne peut pas les definir lui-meme.
                </p>
              </div>
            </div>
          </section>
